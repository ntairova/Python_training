...
@then('The new group list is equal to the old list with the added group', target_fixture="verify_group_add")
def verify_group_add(db, group_list, new_group):
...
@then("The new group list is equal to the old list without deleted group", target_fixture="")
